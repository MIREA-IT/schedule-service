...
type ScheduleServiceClient interface {
	GetGroupSchedule(ctx context.Context, in *GroupScheduleRequest, opts ...grpc.CallOption) (*GroupSchedule, error)
}
...
func (c *scheduleServiceClient) GetGroupSchedule(ctx context.Context, in *GroupScheduleRequest, opts ...grpc.CallOption) (*GroupSchedule, error) {
	out := new(GroupSchedule)
	err := c.cc.Invoke(ctx, "/api.ScheduleService/GetGroupSchedule", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ScheduleServiceServer interface {
	GetGroupSchedule(context.Context, *GroupScheduleRequest) (*GroupSchedule, error)
...
func (UnimplementedScheduleServiceServer) GetGroupSchedule(context.Context, *GroupScheduleRequest) (*GroupSchedule, error) {
...
func _ScheduleService_GetGroupSchedule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ScheduleService/GetGroupSchedule",
	}
...
var ScheduleService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/scheduleService.proto",
}
